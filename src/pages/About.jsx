...
const typeColors = {
    ...
    brk: 'rgba(255,255,255,0.4)',
    white: 'rgba(248,215,218,0.9)',
}
        ...
        <div style={{ paddingTop: 64 }}>
            <section style={{ padding: '80px 48px 90px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
                ...
                <div>
                    ...
                    <h1 style={{ fontFamily: 'var(--bebas)', fontSize: 'clamp(42px, 5vw, 64px)', lineHeight: 0.95, letterSpacing: '.02em', marginBottom: 24 }}>
                    ...
                    <p style={{ fontFamily: 'var(--mono)', fontSize: 11, color: 'var(--muted)', lineHeight: 2, marginBottom: 36 }}>
                        I go after the{' '}
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                        {phases.map((p, i) => (
                            <motion.div
                                ...
                                style={{ padding: 16, background: 'var(--s1)', border: '1px solid var(--border2)', borderRadius: 4, transition: 'all .3s', cursor: 'none' }}
                            >
                                <div style={{ fontFamily: 'var(--bebas)', fontSize: 30, color: 'rgba(232,37,58,0.25)', lineHeight: 1, letterSpacing: '.02em', marginBottom: 6 }}>{p.num}</div>
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '12px 18px', background: '#080408', borderBottom: '1px solid rgba(232,37,58,0.1)' }}>
                    ...
                    <div style={{ padding: '24px 28px', fontFamily: 'var(--mono)', fontSize: 11, lineHeight: 2.1 }}>
                        {codeLines.map(line => (
                            <div key={line.n} style={{ display: 'flex', gap: 16 }}>
                                <span style={{ color: 'rgba(255,255,255,0.15)', userSelect: 'none', minWidth: 16 }}>{line.n}</span>
                                <span>
